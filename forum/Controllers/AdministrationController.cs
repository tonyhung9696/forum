...
namespace forum.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> ArticleManage(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
        ...
        public async Task<IActionResult> DeleteArticle(string id)
        {
            ...
            _SQLArticle.Delete(Convert.ToInt32(id));
            var ReplyItems = _SQLArticleReply.GetAlltem().Where(w=>w.articleID==id);
            var LikeItems = _SQLArticleLike.GetAlltem().Where(w => w.ArticleID == id);
            _SQLArticleReply.DeleteItems(ReplyItems);
            _SQLArticleLike.DeleteItems(LikeItems);
